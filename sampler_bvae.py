...
from parrot.encode_sequence import UserEncoder
import subprocess
...
def run_decode_in_py37() -> None:
    ...
    if result.returncode != 0:
        print(result.stdout)
        print(result.stderr)
        raise RuntimeError(f"decode_file.py failed in env={PY37_ENV_NAME}")
